<?php 
    ...
    if (isset($_POST['carname']) && $_POST['carname'] != '' && 
        ...
        $sql = "INSERT INTO product (`carname`, `idcar`,`price`,`brand`,`sale`,`company`, `satatus`,`dongco`, `level`,`img`,`hopso`,`sit`) VALUES ('$carname','$idcar','$price','$brand','$sale','$company','$satatus','$level','$dongco','$img','$hopso','$sit')";
